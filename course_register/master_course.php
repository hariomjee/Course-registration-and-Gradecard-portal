...
<body  style="background-image: url('/online course registration system/back2.jpg');background-repeat: no-repeat;
    ...
    <nav class="navbar navbar-expand-lg  navbar-dark bg-dark  justify-content-start ">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          <a class="nav-link active" href="/online course registration system/course_register/master_course.php">Edit Master Course</a>
  ...
  <div class="container">
    ...
    <div class="row">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body ">
                <div class="row">
                  <div class="col">
                    <label class="text-uppercase">course_code :</label>
                    <input class="" type="text" name="code" id="code" />
                  </div>
                </div>
                <div class="row">
                  <div class="col">
                    <label class="text-uppercase">course_title:</label>
                    <input class="text-uppercase"  type="text" name="title" id="title" required />
                  </div>
                </div>
                <div class="row">
                  <div class="col">
                ...
                <div class="row">
                  <div class="col">
                    <label class="text-uppercase">Cr:</label>
      ...
      <!-- upload csv file -->
      <div class="col">
        <form id="upload_csv" action="/online course registration system/course_register/courseCsv.php" name="upload_excel" method="post" enctype="multipart/form-data">
          <div class="form-row">
            <div class="col">
              <input type="file" name="file" id="csv_file" accept=".csv" style="margin-top:15px;" />
            </div>
            <div class="col">
              <button class="btn btn-primary mt-3" type="submit" name="upload" id="Upload">Upload</button>
            </div>
            ...
            <div class="modal-body ">
              <div class="row">
                <div class="col">
                  ...
                  <input class="text-uppercase" type="text" name="code" id="c_code" />
                </div>
              </div>
              <div class="row">
                <div class="col">
                  <label>course_title:</label>
                  <input class="text-uppercase" type="text" name="title" id="c_title" />
                </div>
              </div>
              <div class="row">
                <div class="col">
  ...
  <div>
    ...
    <script src="/online course registration system/global/js/bootstrap.min.js"></script>
    <script src="/online course registration system/course_register/master_course.js"></script>
