...
<html lang="en">
  ...
  background-size: cover;background-size: 100% 100%;">
    ...
    <div class="mainDiv">
      <div class="Innerdiv" style="padding: 50px;margin: 60px;font-size: 20px;">
      <div class="container">
  ...
  <div class="row"style="margin:2%">
    ...
    <div class="col-lg-8 ">
      <label class="text-info" style="font-size:24px"  id="lblRollNo">Username</label>
    </div>
    <div class="col-lg-2 ">
  ...
  <div class="row"style="margin:2%">
    ...
    <div class="col-lg-8">
      <input class="loginTextBox" size="60" id="txtRollNo" type="text">
    </div>
    <div class="col-lg-2">
  ...
  <div class="row"style="margin:2%">
    ...
    <div class="col-lg-8">
      <input class="loginTextBox" size="60" id="txtPwd" type="password">
    </div>
    <div class="col-lg-2">
...
<div class="col-lg-2">
    ...
    <div class="col-lg-8">
      <div>
      <button class="btn btn-success" id="AdminLogin">Admin</button>
     <button class="btn btn-success float-right" id="FacultyLogin">Faculty</button>
</div>
    </div>
    <div class="col-lg-2">
...
<script src="/online course registration system/global/js/bootstrap.min.js"></script>
<script src="/online course registration system/Admin/Alogin.js"></script>
</div>
